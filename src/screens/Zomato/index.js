...
function Zomato(props: Props) {
  ...
  const stories = [
    {
      id: '4',
      source: require('../../assets/images/healthcare.jpeg'),
      user: 'Ugur Erdal',
      avatar: require('../../assets/images/healthcare.jpeg'),
    },
    {
      id: '2',
      source: require('../../assets/images/healthcare.jpeg'),
    ...
    <View style={{flex: 1}}>
      <View>
        <TopBar
          ...
          renderExtremeRightContainer={() => <Avatar initials="AS" />}
        />
      </View>
      <ScrollView style={styles.viewPager} showPageIndicator={true}>
        ...
        <ScrollView
          ...
          contentContainerStyle={{
            ...
            paddingHorizontal: Platform.OS === 'android' ? 30 : 0, // Horizontal spacing before and after the ScrollView
          }}>
